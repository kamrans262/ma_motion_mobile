...
void main() {
  ...
  testWidgets(
    'Video longer than five seconds opens styled warning and closes',
    (tester) async {
  ...
  testWidgets(
    'Passwordless confirmation cancels safely and deletes only on Confirm',
    (tester) async {
  ...
  testWidgets(
    'Password-based account still requires password and does not close on API failure',
    (tester) async {
...
class _AccountApi implements ApiGateway {
  ...
  Future<Map<String, dynamic>> delete(
    ...
    if (hasPassword &&
        lastDeleteData?['current_password'] != 'correct-password') {
